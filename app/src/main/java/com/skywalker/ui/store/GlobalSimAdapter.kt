...
import com.skywalker.databinding.AdapterGlobalSimCardBinding
import com.skywalker.databinding.AdapterSimCardBinding
import com.skywalker.model.respone.PlanDataItem

class GlobalSimAdapter(val context: Context) :
    ListAdapter<PlanDataItem, GlobalSimAdapter.OptionsViewHolder>(OPTIONS_DIFF_UTIL) {
    ...
    class OptionsViewHolder(
        ...
        LayoutInflater.from(parent.context).inflate(R.layout.adapter_global_sim_card, parent, false)
    ) {

        private val binding = AdapterGlobalSimCardBinding.bind(itemView)
